...
(function () {
  ...
  if (!Object.keys) {
    Object.keys = function () {
      ...
      return function (obj) {
        if (_typeof2(obj) !== 'object' && (typeof obj !== 'function' || obj === null)) {
...
(function (root, undefined) {
  'use strict'; // only create tick extensions queue if not already available
...
(function (root, plugins, undefined) {
  'use strict'; // Cut the mustard for really old browsers
  ...
  var Tick = function () {
    ...
    var destroyer = function destroyer(state) {
      return {
    ...
    var rooter = function rooter(state) {
    ...
    var grouper = function grouper(state, definition) {
    ...
    var drawer = function drawer(state, _draw, drawViews, present) {
      return {
        draw: function draw() {
    ...
    var resizer = function resizer(state) {
    ...
    var createRoot = function createRoot(root, definition, present) {
      var state = {
    ...
    var createRepeater = function createRepeater(root, definition, present) {
      var state = {
        definitions: []
      };
    ...
    var cache = function cache(value, fn) {
      var fns = fn.toString();
    ...
    var styler = function styler(state) {
    ...
    var Tick = function () {
      function Tick() {
        ...
        this._presets = null;
        this._updater = null;
        this._credits = null; // callback methods
      ...
      createClass(Tick, [{
        ...
        value: function _init() {
          ...
          this._credits = this._options.credits; // no more use of options behind this line
          // ---------------------------------------
          ...
          this._didInit(this, this.value); // credits
    ...
    var add$1 = function add$1(amount) {
      return function (value, cb) {
    ...
    var value$1 = function value$1(staticValue) {
      return function (value, cb) {
        return cb(staticValue);
      };
    };

    var modulus = function modulus(amount) {
      return function (value, cb) {
        return cb(value % amount);
      };
    };

    var subtract = function subtract(amount) {
      return function (value, cb) {
        return cb(value - amount);
      };
    };

    var replace = function replace(needle, replacement) {
    ...
    var multiply = function multiply(amount) {
      return function (value, cb) {
        return cb(value * amount);
      };
    };

    var divide = function divide(amount) {
      return function (value, cb) {
        return cb(value / amount);
      };
    };
    ...
    var plural = function plural(single, _plural) {
      return function (value, cb) {
        return cb(value === 1 ? single : _plural);
      };
    };
    ...
    var arrive$1 = function arrive$1(maxVelocity, friction) {
    ...
    var spring$1 = function spring$1(stiffness, damping, mass) {
      var current = null;
      var translator = null;
      return function (value, cb) {
        value = parseFloat(value);
    ...
    var step$1 = function step$1(velocity) {
      var initial = null;
      var previous = null;
      var translator = null;
      return function (value, cb) {
    ...
    var duration$1 = function duration$1() {
    ...
    var substring = function substring(from, to) {
      return function (value, cb) {
        return cb((value + '').substring(from, to));
      };
    };

    var tween = function tween(duration) {
    ...
    var _char = function _char(filter) {
      var replacement = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var regex = filter ? new RegExp('[^' + filter + ']', 'g') : null;
      return function (value, cb) {
        var _char2 = String.fromCharCode(value);

        if (regex) {
          _char2 = _char2.replace(regex, replacement);
        }
  ...
  (function () {
    ...
    Tick.push = add; // loop over already pushed extensions and add to Tick

    plugins.forEach(add); // expose globally (overwriting extension array)
