    ...
    var n = function () {
      ...
      var it = Object.assign || function (t) {
        ...
        return e.style.cssText = "position:absolute;visibility:hidden;color:" + t, document.body.appendChild(e), requestAnimationFrame(function () {
          ...
          Mt = {
        "ease-linear": nt,
        "ease-in-sine": function easeInSine(t) {
          return -1 * Math.cos(t * (Math.PI / 2)) + 1;
        },
        "ease-out-sine": function easeOutSine(t) {
          return Math.sin(t * (Math.PI / 2));
        },
        "ease-in-out-sine": function easeInOutSine(t) {
          return -.5 * (Math.cos(Math.PI * t) - 1);
        },
        "ease-in-cubic": function easeInCubic(t) {
          return t * t * t;
        },
        "ease-out-cubic": function easeOutCubic(t) {
          var e = t - 1;
          return e * e * e + 1;
        },
        "ease-in-out-cubic": function easeInOutCubic(t) {
          return t < .5 ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1;
        },
        "ease-in-circ": function easeInCirc(t) {
          var e = +t;
          return -1 * (Math.sqrt(1 - e * t) - 1);
        },
        "ease-out-circ": function easeOutCirc(t) {
          var e = t - 1;
          return Math.sqrt(1 - e * e);
        },
        "ease-in-out-circ": function easeInOutCirc(t) {
          var e = 2 * t,
              n = e - 2;
          return e < 1 ? -.5 * (Math.sqrt(1 - e * e) - 1) : .5 * (Math.sqrt(1 - n * n) + 1);
        },
        "ease-in-quad": function easeInQuad(t) {
          return t * t;
        },
        "ease-out-quad": function easeOutQuad(t) {
          return t * (2 - t);
        },
        "ease-in-out-quad": rt,
        "ease-in-quart": function easeInQuart(t) {
          return t * t * t * t;
        },
        "ease-out-quart": function easeOutQuart(t) {
          return 1 - --t * t * t * t;
        },
        "ease-in-out-quart": function easeInOutQuart(t) {
          return t < .5 ? 8 * t * t * t * t : 1 - 8 * --t * t * t * t;
        },
        "ease-in-expo": function easeInExpo(t) {
          return 0 === t ? 0 : Math.pow(2, 10 * (t - 1));
        },
        "ease-out-expo": function easeOutExpo(t) {
          return 1 === t ? 1 : 1 - Math.pow(2, -10 * t);
        },
        "ease-in-out-expo": function easeInOutExpo(t) {
          if (0 === t || 1 === t) return t;
          var e = 2 * t,
              n = e - 1;
          return e < 1 ? .5 * Math.pow(2, 10 * n) : .5 * (2 - Math.pow(2, -10 * n));
        },
        "ease-in-back": function easeInBack(t, e) {
          var n = 1 < arguments.length && e !== cn ? e : 1.70158,
              r = +t;
          return r * r * ((n + 1) * r - n);
        },
        "ease-out-back": function easeOutBack(t, e) {
          var n = 1 < arguments.length && e !== cn ? e : 1.70158,
              r = t - 1;
          return r * r * ((n + 1) * r + n) + 1;
        },
        "ease-in-out-back": function easeInOutBack(t, e) {
          var n = 2 * t,
              r = n - 2,
              i = 1.525 * (1 < arguments.length && e !== cn ? e : 1.70158);
          return n < 1 ? .5 * n * n * ((1 + i) * n - i) : .5 * (r * r * ((1 + i) * r + i) + 2);
        },
        "ease-out-elastic": function easeOutElastic(t, e) {
        ...
        "ease-out-bounce": function easeOutBounce(t) {
          var e = +t;
      ...
      function Ct(t) {
        ...
        var a,
          ...
          cancel: l,
          translate: function translate(r, t, e, i) {
      ...
      var Ye = [],
        ...
        substring: function substring(n, r) {
          return function (t, e) {
      ...
      var nn = {
        ...
        y: "scaleY"
          ...
          an = {
        fade: function fade(t, e, n, r, i, o) {
        ...
        move: function move(t, e, n, r, i, o, a) {
        ...
        rotate: function rotate(t, e, n, r, i, o, a) {
          var u = 3 < arguments.length && r !== cn ? r : rt,
              l = 4 < arguments.length && i !== cn ? i : "0",
        ...
        scale: function scale(t, e, n, r, i, o, a) {
      ...
      var ln = {
        ...
        options: {
          setConstant: function setConstant(t, e) {
            He[t] = e;
          },
          setPreset: function setPreset(t, e) {
            $e[t] = e;
          }
        },
        helper: {
        ...
        count: {
          ...
          schedule: function schedule(i, t) {
